...
from data import CSPTask, resolve_data_root
from diffusionModels.trivialized_diffusion import TrivialisedDiffusion
from kldm import ModelKLDM
...
def validation_step(
    ...
    t_graph = model.sample_graph_times(num_graphs=batch.num_graphs, device=device)
