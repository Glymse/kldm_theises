...
class TrivialisedDiffusion(nn.Module):
    ...
    def forward_sample(
        ...
        wrapped_gaussian_mu_r_t_pre_wrap = self.wrapped_gaussian_mu_r_t_pre_wrap(
            t=t,
            v_t=v_t_internal,
            v0=v0_internal,
        )
        ...
        r_t_internal = self.wrap_angles(
            wrapped_gaussian_mu_r_t_pre_wrap + wrapped_gaussian_sigma_r_t * epsilon_r
        )
